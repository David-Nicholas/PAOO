...
int main() {
    ...
    Vehicul car3 = car1; // Copy assignment 
    std::cout << "\nVehicul 3 (copie a vehicului 1): \n";
    car3.print();

    Vehicul car4 = std::move(car2); // Move assignment
    ...
    std::cout << "\nVehicul 3 dupa schimbari numar si culoare: \n";
    car3.print();

    std::cout << "Vehicul 1 Numar Inmatriculare: " << car1.getNumar_inmatriculare() << "\n";
    std::cout << "Vehicul 3 Marca: " << car3.getMarca() << "\n";
